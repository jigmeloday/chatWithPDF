        ...
        <div>
            ...
            <div>
                <div className='relative isolate'>
                    ...
                    <div className='flex flex-col lg:flex-row justify-center items-center space-y-8 lg:space-y-0 lg:space-x-12 mx-auto max-w-6xl px-6 lg:px-8'>
                        <div className='flex flex-col justify-between bg-gray-900/5 p-8 rounded-md w-full lg:w-1/3 h-[200px]'>
